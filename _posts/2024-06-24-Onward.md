...
---
<center><p><i>Detail from Forgotten Signs: "Year of the Journey"</i></p></center>
...
Most of my promo efforts went to places where I hoped the might the attention of  people whose first words weren't likely to be: "what was the shutter speed on this one?"
...
My belief, going into the event, was that the books --  _[Forgotten Signs,]({{ site.url}}/books/signs)_  _[Graffiti Generations,]({{ site.url}}/books/generations)_ and work from the _Liquidity SF_ series:_[CHAMPIONS]({{ site.url}}/books/champions)_ and _[Sooner or Later Someone's Going to Get Hurt]({{ site.url}}/books/hurt)_ -- would elicit the most interest and be the strongest sellers.
...
4. They saw a generic "Art at the Source" placard as they were on a walk along the very nearby Joe Rodotoa Trail.
...
9. They saw _["The Two Algorithms of Life"]({{ site.url}}/books/two)_ at the SebArts Gallery and felt they needed to see what was going on over at Studio 16b.
...
None of these reasons are meant to align with whether or not someone will buy art, or even notice it, much less engage with the it enough to browse through the stacks or open a sample book.
...
<img src="https://www.botzilla.com/pix2024/bjorke_dancing_illo2.jpg">
<figcaption>Detail from <i>Dancing with No One</i></figcaption>
</figure>

#### Surprises: _No One_ was First

The work that attracted the most sales attention, by far, was _[Dancing with No One.]({{ site.url}}/books/dancing)_  Several prints sold, all of them at the larger size, and of the two editions of the book I had on hand -- softcover or larger hardcover -- nearly all of the hardcovers sold. 
...
Similarly, the larger and hardcover edition of _Forgotten Signs_ was prefered over the softcover. Those two projects were the ones with two editions, and basically, the nearly all the softcovers that moved out of the studio were ones bundled with an associateed print.

Every [book title]({{ site.url}}/books24) sold at least _one_ copy. I am thankful for that. But some titles: more.
...
As for _[RBF,]({{ site.url}}/books/rbf)_ once I bundled the cards in sets of six they did sell better (and six at a time). I also received a request to provide some to a retailer, which is terrific! Expect to see details about that soon.
...
Exhibiting here in my Petaluma space is likely the largest hazard. It's larger, sure. I can show more works, even have my portrait studio up and ready to go. Maybe a drawing robot. The hazard is the less-touristy location.

In Sebastopol, there were a dozen other studios within walking distance. Here, people must drive. There are no other studios nearby, and worse, there isn't a downtown four blocks away with restaurants to feed visiting weekenders.

Many of the people who discovered my work during _Art at the Source_ were the +1's or others who started browsing while waiting for their friends and partners who were visiting Barbara's jewelry offerings. In Petaluma, with no one else in the space, no nearby studios, not tourism infrastructure, it will be a different challenge, a challenge to get even one person to appear at the door, becasue they came to see something that they think will be worth seeing.

I have many new and unseen artworks to share, that's not really a question. And I have plans for a completely new piece for the gallery reception already. If I had to ship it all by the weekend... hmm, it's Tuesday? Yeah, I could be open for business, though I'd prefer some time to lay the groundwork.
...
In setting up for a reprint of _[Dancing with No One]({{ site.url}}/books/dancing)_ I found a fault in the book layout. And fixed it. And added a bookstore-friendly external ISBN code.
...
Small runs are very pricey per-book. Even at $60, the hardcover _Dancing with No One_ had to sell with a narrow margin. Typically, the routes to solving this are either double-down on exotic quality and raise prices for a low-run item, or find a different distribution channel so that prices can be lower at the cost of a risky large intial print run. Problems, problems.
