...
As with many great ideas, this one starts with... beer! In 1952 physicist Donald A. Glaser invented the ["bubble chamber,"](https://en.wikipedia.org/wiki/Bubble_chamber) a device for tracing the motions of charged particles moving through a liquid. [_Some of the initial experiments used beer inside the chamber._](https://www2.lbl.gov/Publications/Currents/Archive/Jul-21-2006.html#6) Of course they did, this was at a university. But the only reported results were some bad smells (seriously). Switching from beer to liquid hydrogen led to Glaser winning the Nobel Prize only eight years later, in 1960.
...
* Lines can be points
* An infinite collection of lines can be a line (of lines)
  * ...or a curve (of lines)
* When drawn in a collection of pixel points, curves can vote for the best lines
