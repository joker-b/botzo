...
The world is full of patterns. Any kind of pattern: art, physics, music. In some camps, it's been proposed that human ability to grasp at patterns is the core of conscious experience. We understand our surroundings, and one another, as a complex carpet of overlapping and expected patterns. Often the patterns are hard to fathom at first, but unexpectedly, like the sudden twist in a mysterious story, _Aha!_ the experience of understanding. It all makes sense now.
...
The story of the Hough Transform begins with our last question above: what about the beer?
...
A problem with this description is that vertical lines, where the slope is infinite, can't be drawn. This worked out okay for Hough's specific case. It worked great for him. But it's kind of bad if we want to use this to look at most everyday pictures, which have lots of vertical lines relating to buildings, trees, and so forth.
