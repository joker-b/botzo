...
The story of the Hough Transform begins with our last question above.
...
The problem Hough was trying to get at was: how to find straight lines in very low-quality, sketchy, incomplete pictures? Including ones where there's a lot of extra noise from spurious bubbles, low-quality signals (this is 1959, using a 1950's-era TV camera), and to do it _quickly_ (at TV camera speed)?
...
A problem with this description is that vertical lines, where the slope is infinite, can't be drawn. This worked out okay for Hough's specific case, but it's kind of bad if we want to use this to look at most everyday pictures, which have lots of vertical lines relating to buildings, trees, and so forth.
